...
import { Eye, EyeOff, Lock, ChevronLeft, LogOut, Save, Shield, UserCircle } from "lucide-react";
        ...
        <div className="min-h-screen bg-gray-50">
            ...
            <div className="max-w-4xl mx-auto p-6">
                ...
                <div className="flex items-center gap-4 mb-8">
                    <div className="w-16 h-16 rounded-full bg-gradient-to-br from-fuchsia-500 to-blue-600 flex items-center justify-center
                    ...
                    <section className={SECTION_WRAPPER}>
                        ...
                        <form onSubmit={changePassword} className="space-y-4">
                            ...
                            <div  key={name} className={INPUT_WRAPPER}>
                                ...
                                <input type={isShowPassword && name === 'new' ? "text" : "password"} placeholder={placeholder} value={passwords[name]} 
