...
const Sidebar = ({user, tasks}) => {
    ...
    return (
        ...
        <div className={SIDEBAR_CLASSES.desktop}>
            <div className="p-5 border border-blue-100 lg:block hidden">
                <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-full bg-gradient-to-br from-fuchsia-500 
                    to-blue-600 flex items-center justify-center text-white font-bold shadow-md">
                        {initial}
                    </div>
                    ...
                    <div className={TIP_CARD.container}>
                        <div className="items-center flex gap-2">
                            ...
                            <div>
                                ...
                                <p className={TIP_CARD.text}>Use keyboard shortcuts to improve productivity!</p>
                                <a 
                                href="https://koalanotesapp.netlify.app/" 
                                target="_blank"
                  ...
                  <div className="mt-6">
                    <div className={TIP_CARD.container}>
                        <div className="flex items-start gap-3">
                            ...
                            <div>
                                <h3 className={TIP_CARD.title}>Pro Tip</h3>
                                <p className={TIP_CARD.text}>Use desktop to improve productiviy</p>
                                <a 
                                href="https://koalanotesapp.netlify.app/"
                                target="_blank"
                                className="block mt-2 text-sm text-blue-500 hover:underline"
